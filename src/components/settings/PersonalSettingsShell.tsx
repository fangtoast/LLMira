...
import { ArrowLeft, Bot, ChevronRight, Database, Globe2, Info, Palette, Plus, Server, Settings2, Sparkles, Trash2, Wrench, type LucideIcon } from "lucide-react";
...
type SettingsSection = "providers" | "defaults" | "mcp" | "search" | "appearance" | "data" | "about";
...
const groups: Array<{ label: string; items: Array<{ id: SettingsSection; label: string; Icon: LucideIcon }> }> = [
  ...
  { label: "系统", items: [{ id: "data" as const, label: "数据", Icon: Database }, { id: "about" as const, label: "关于", Icon: Info }] },
];
...
export function PersonalSettingsShell() {
  ...
  return (
    <div className="flex min-h-dvh bg-background text-foreground md:h-dvh md:overflow-hidden">
      ...
      <main className="min-w-0 flex-1 pb-28 md:overflow-y-auto md:pb-0">
        ...
        <div className="mx-auto grid max-w-[1120px] gap-5 px-4 py-5 md:px-8 md:py-7 lg:px-10">
